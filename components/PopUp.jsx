    ...
    <>
      ...
      >
        <div class="relative w-full max-w-2xl max-h-full">
          <div class="relative bg-[#2D2E33] rounded-lg shadow ">
            <div class="flex items-start justify-between p-4 border-b border-gold rounded-t">
              <h3 class="text-xl font-semibold text-gold ">Shuffled Users</h3>
              <button
                type="button"
                class="text-gold bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center "
